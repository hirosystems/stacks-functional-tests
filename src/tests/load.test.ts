...
import { logger, stopwatch, timeout } from '@hirosystems/api-toolkit';
...
const LOAD_TEST_TRANSACTIONS = 1_000;
// Control what parts to run
// Because this test takes a long time to run, we may want to run parts separately
const RUN_TEST_SETUP = true;
const RUN_TEST = true;
